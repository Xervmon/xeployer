...
<body>
	<div class="welcome">
		...
		<a  href="dashboard/login" class="btn btn-block btn-large btn-primary" style="width:40%"><?= Lang::get('index.login'); ?></button> 
			| <a  href="dashboard/login" class="btn btn-block btn-large btn-register" style="width:40%"><?= Lang::get('index.register'); ?></button>
